...
object EmailTemplates {
  def emailActivationTemplate(
    ...
    s"""<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
       ...
       |
       |      <img align="left" border="0" src="images/image-3.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 38%;max-width: 197.6px;" width="197.6" class="v-src-width v-src-max-width"/>
       |
       |    </td>
       |  </tr>
       |</table>
       ...
       |
       |      <img align="center" border="0" src="images/image-2.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 400px;" width="400" class="v-src-width v-src-max-width"/>
       |
       |    </td>
       |  </tr>
       |</table>
       ...
       |<p style="font-size: 14px; line-height: 160%;"><span style="font-family: Raleway, sans-serif; font-size: 14px; line-height: 22.4px;">Your username is:&nbsp; "<em><strong><span style="color: #2dc26b; font-size: 14px; line-height: 22.4px;">UsernameXX "</span></strong></em></span></p>
       |  </div>
       |
       |      </td>
       |    </tr>
       ...
       |<p style="font-size: 14px; line-height: 180%;">you just need to set your <span style="color: #f1c40f; font-size: 14px; line-height: 25.2px;">password.</span></p>
       |  </div>
       |
       |      </td>
       |    </tr>
       ...
       |  <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:'Raleway',sans-serif;"><tr><td class="v-text-align" style="font-family:'Raleway',sans-serif;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="$link" style="height:37px; v-text-anchor:middle; width:201px;" arcsize="54%" strokecolor="#f1c40f" strokeweight="2px" fillcolor="#2dc26b"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Raleway',sans-serif;"><![endif]-->
       |    <a href="$link" target="_blank" style="box-sizing: border-box;display: inline-block;font-family:'Raleway',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #2dc26b; border-radius: 20px;-webkit-border-radius: 20px; -moz-border-radius: 20px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;border-top-color: #f1c40f; border-top-style: solid; border-top-width: 2px; border-left-color: #f1c40f; border-left-style: solid; border-left-width: 2px; border-right-color: #f1c40f; border-right-style: solid; border-right-width: 2px; border-bottom-color: #f1c40f; border-bottom-style: solid; border-bottom-width: 2px;">
       ...
       |          <img src="images/image-1.png" alt="WhatsApp" title="WhatsApp" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
       |        </a>
       |      </td></tr>
       |    </tbody></table>
       |    <!--[if (mso)|(IE)]></td><![endif]-->
       ...
       |          <img src="images/image-5.png" alt="Tripadvisor" title="Tripadvisor" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
       |        </a>
       |      </td></tr>
       |    </tbody></table>
       |    <!--[if (mso)|(IE)]></td><![endif]-->
       ...
       |          <img src="images/image-4.png" alt="Spotify" title="Spotify" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
       |        </a>
       |      </td></tr>
       |    </tbody></table>
       |    <!--[if (mso)|(IE)]></td><![endif]-->
